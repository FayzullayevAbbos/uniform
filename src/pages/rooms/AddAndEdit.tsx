...
import {rooms} from "../../service/URLs.ts";

interface AddSectionDrawerProps {
  open: boolean,
  onClose: () => void,
  editData?: { id:number; name: string; room_number:number; order: number; is_active: number | null } | null,
  refetch?: never
}
    ...
    <Drawer
      title={
        <span className="font-semibold text-lg">
          {editData ? "Xonani tahrirlash" : "Yangi xona qo‘shish"}
        </span>
      }
      placement="right"
      closable
