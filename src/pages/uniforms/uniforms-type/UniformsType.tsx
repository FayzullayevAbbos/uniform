...
import {departments, types} from "../../../service/URLs.ts";
...
const UniformsType: React.FC = () => {
  ...
  const handleDelete = (item: DataType) => {
    Modal.confirm({
      title: "Haqiqatan ham ushbu turni o‘chirmoqchimisiz?",
        ...
        <div className="bg-white border w-full rounded-2xl mt-4 px-4 pt-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-2 mb-2 border-b w-full">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              ...
              />
              <Button icon={<PlusIcon width={16}/>} onClick={() => setOpen(true)} type="primary">
                Yangi qo‘shish
              </Button>
            </div>
          </div>
